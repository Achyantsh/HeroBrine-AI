...
def save_commitments(
    ...
    return _call_or_raise(service.ingest_text, payload.text)
...
def extract_commitments_from_pdf(
    ...
    """Extract commitments from a PDF upload and persist them."""

    return _call_or_raise(service.ingest_pdf, file)
...
def extract_commitments_from_image(
    ...
    """Extract commitments from an image upload and persist them."""

    return _call_or_raise(service.ingest_image, file)
...
def extract_commitments_from_voice(
    ...
    """Extract commitments from an audio upload and persist them."""

    return _call_or_raise(service.ingest_voice, file)